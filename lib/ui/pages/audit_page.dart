          ...
          rows: widget.controller.auditPage.entries.map((entry) {
            ...
            return DataRow(
              ...
              cells: [
                ...
                DataCell(
                  Text(
                    '${_icon(entry.changeType)} ${_typeLabel(entry.changeType)}${entry.sourceReference.isEmpty ? '' : ' · ${entry.sourceReference}'}',
                    maxLines: 1,
          ...
          children: [
            ...
            if (selected != null) ...[
              ...
              FilledButton.tonalIcon(
                onPressed: selected.deltaQuantity == 0 || selected.changeType == 'SALE' || selected.changeType == 'ROLLBACK_REVERSAL'
                    ? null
                    : _rollback,
                icon: const Icon(Icons.undo),
                label: const Text('Rollback Selected Entry'),
              ),
              if (selected.changeType == 'SALE') ...[
                const SizedBox(height: 6),
                Text(
                  'Sales are voided from the Sales page so every line is reversed together.',
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              FilledButton.tonalIcon(
                onPressed: selected == null || selected.deltaQuantity == 0 || selected.changeType == 'SALE' || selected.changeType == 'ROLLBACK_REVERSAL'
                    ? null
                    : _rollback,
                icon: const Icon(Icons.undo),
