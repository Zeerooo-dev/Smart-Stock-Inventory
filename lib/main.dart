...
class _SmartStockApplicationState extends State<SmartStockApplication> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        final theme = SmartStockThemes.build(widget.controller.theme, accent: widget.controller.customAccent);
        return MaterialApp(
          ...
          home: widget.controller.loading
              ...
              : widget.controller.startupError != null
                  ? _StartupError(message: widget.controller.startupError!, controller: widget.controller)
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            const Text('Enter the previous database passphrase. A recovery copy is retained before migration.'),
            TextField(onChanged: (value) => enteredPassphrase = value, obscureText: true, autocorrect: false,
              enableSuggestions: false, decoration: const InputDecoration(labelText: 'Previous passphrase')),
          ]),
        ),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context), child: const Text('Cancel')),
          FilledButton(onPressed: () => Navigator.pop(context, enteredPassphrase), child: const Text('Unlock')),
        ],
      ),
    );
            ...
            child: Card(
              child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('SmartStock could not open its database.', style: Theme.of(context).textTheme.titleLarge, textAlign: TextAlign.center),
