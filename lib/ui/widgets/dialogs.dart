                ...
                .map(
                  (entry) => DataRow(
                    cells: [
                      ...
                      DataCell(Text(entry.sourceReference.isEmpty ? '—' : entry.sourceReference)),
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (entry.sourceReference.isNotEmpty) ...[
                  const SizedBox(height: 3),
                  Text('Reference: ${entry.sourceReference}', style: Theme.of(context).textTheme.bodySmall),
                ],
                const SizedBox(height: 8),
                Wrap(
                  spacing: 8,
